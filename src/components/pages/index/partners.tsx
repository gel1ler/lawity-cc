...
const Partners = () => {
    return (
        <div className="bg-white w-screen flex flex-col items-center py-20">
            <H className='text-center' level={2}>Наши клиенты и кейсы</H>
            <p className='text-lg max-w-2xl text-center'>Примеры успешного сотрудничества с юридическими компаниями</p>
            <RunningLine />
        </div>
    )
}
